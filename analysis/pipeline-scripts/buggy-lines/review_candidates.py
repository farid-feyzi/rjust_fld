#!/usr/bin/python3
#
# For each of many Defects4J bugs (listed in a CSV file),
# this script shows the user the patch and asks whether she/he agrees with
# the manually determined candidates lines for each fault of omission. This
# script writes the user's answer to a file called 'review', including a comment
...
#
# The <CSV file> must NOT have a header and must have two columns, specifying
# the project and bug IDs of the faults to review candidates for.
#
# Example <CSV file>:
#   --------
#   bugs.csv
