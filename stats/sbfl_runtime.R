...
print_macro("totalSBFLRuntimeHours",
        paste(round(sum(df$"runtime")/3600/1000, 0) * 1000, "hours", sep=" "))
print_macro("meanSBFLRuntimeHours",
        paste(round(mean(df$"runtime")/3600, 1), "hours", sep=" "))
